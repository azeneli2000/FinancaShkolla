<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Aktiv_pasiv.aspx.cs" Inherits="financa_shkolla.Account.Aktiv_Pasiv" %>
        ...
        <tr>
            <td class="style2">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                    ...
                    Text="Aktivizimi i kesteve te transportit"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
            <td>
