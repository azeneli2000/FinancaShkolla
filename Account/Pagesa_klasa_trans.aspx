<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pagesa_klasa_trans.aspx.cs" Inherits="financa_shkolla.Account.Pagesa_klasa_trans" %>
        ...
        <tr>
            <td style="color: #003366" class="style1">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" 
                    ...
                    Text="Pagesa e transportit sipas klasave"></asp:Label>
                </td>
            <td>
                &nbsp;</td>
            <td>
